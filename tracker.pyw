...
class Tracker(Tk.Tk):
    ...
    DEFAULT_LAYOUT = "[{'tab_image': 'bar', 'text': 'Bars', 'raids': [{'raid_image': 'bhl', 'text': 'BHL', 'loot': ['blue', 'ring3', 'bar']}, {'raid_image': 'akasha', 'text': 'Akasha', 'loot': ['blue', 'ring3', 'bar']}, {'raid_image': 'gohl', 'text': 'Grande', 'loot': ['blue', 'ring3', 'bar']}]}, {'tab_image': 'sand', 'text': 'Sands', 'raids': [{'raid_image': 'ennead', 'text': 'Enneads', 'loot': ['sand']}, {'text': 'M3', 'raid_image': 'm3', 'loot': ['sand']}, {'text': 'Taboo', 'raid_image': 'taboo', 'loot': ['sand']}, {'raid_image': '6d', 'text': '6D', 'loot': ['fireearring', 'sand']}, {'text': 'World', 'raid_image': 'world', 'loot': ['blue', 'world_idean', 'sand']}]}, {'tab_image': 'siete', 'text': 'Revans', 'raids': [{'raid_image': 'mugen', 'text': 'Mugen', 'loot': ['blue', 'wpn_mugen', 'wpn_mugen2', 'sand']}, {'raid_image': 'diaspora', 'text': 'Diaspora', 'loot': ['blue', 'wpn_diaspora', 'wpn_diaspora2', 'sand']}, {'raid_image': 'siegfried', 'text': 'Siegfried', 'loot': ['blue', 'wpn_siegfried', 'wpn_siegfried2', 'sand']}, {'raid_image': 'siete', 'text': 'Siete', 'loot': ['blue', 'wpn_siete', 'wpn_siete2', 'sand']}, {'raid_image': 'cosmos', 'text': 'Cosmos', 'loot': ['blue', 'wpn_cosmos', 'wpn_cosmos2', 'sand']}, {'raid_image': 'agastia', 'text': 'Agastia', 'loot': ['blue', 'wpn_agastia', 'wpn_agastia2', 'sand']}]}, {'text': 'Trials', 'tab_image': 'paragon', 'raids': [{'text': 'Paragon', 'raid_image': 'paragon', 'loot': ['blue', 'sand']}, {'text': 'Witch', 'raid_image': 'witch', 'loot': ['blue', 'sand', 'witch_manatura']}, {'text': 'Performer', 'raid_image': 'performer', 'loot': ['blue', 'sand']}]}, {'text': 'End', 'tab_image': 'subaha', 'raids': [{'raid_image': 'subaha', 'text': 'SuBaha', 'loot': ['sand']}, {'raid_image': 'hexa', 'text': 'Hexa', 'loot': ['sand']}, {'text': 'LuciZero', 'raid_image': 'lucizero', 'loot': ['sand']}, {'text': 'Versusia', 'raid_image': 'versusia', 'loot': ['sand']}]}, {'text': 'Others', 'tab_image': 'unknown', 'raids': [{'text': 'GW NM', 'raid_image': 'nm', 'loot': ['wpn_celestial', 'wpn_revenant', 'summon_gw']}]}]"
    RAID_TAB_LIMIT = 6
    MIN_WIDTH = 240
    MIN_HEIGHT = 150
    SMALL_THUMB = (20, 20)
    ...
    def show_changelog(self) -> None: # display the changelog
        changelog = [
            "1.71 - Added Taboo raids.",
            "1.70 - Added the Versusia Genesis raid.",
            "1.69 - Added the Phantasmal Performer raid.",
            "1.68 - Added the Manatura to the blue chest loot of Omni-Magia Witch.",
            "1.67 - Created a tab for Trial raids. Redesigned the Settings tab icon.",
...
class History(Tk.Toplevel): # history window
    ...
    def update_history(self) -> None:
        ...
        if line_index == 1 and column == 0:
            Tk.Label(self, text="No History available for this raid").grid(row=line_index, column=column, sticky="w")
